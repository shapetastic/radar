...
/// Whether THIS baseline satisfies its share of the AD-15 gate: interval defined, median strictly positive,
/// interval lower bound strictly positive. The overall gate additionally needs the boundary and predeclared
/// primary — see <see cref="PairedStrategyComparison.QualifiesUnderAd15"/>.
/// </param>
...
/// friendlier gate: <see cref="QualifiesUnderAd15"/> is computed inside the harness.
/// <para>
...
/// </param>
/// <param name="GateReasons">
/// Every reason the gate did not pass, as stable machine-readable tokens; empty exactly when
/// <see cref="QualifiesUnderAd15"/> is true.
/// </param>
