...
public sealed class RadarScoreFormulaV11CompositionGuardTests
{
    ...
    /// </para>
    /// <para>
    /// SPEC 224 MOVES IT AGAIN (radar-scoring-fp-32a50355b568 → the value below), for a hashed field outside this
    ...
    /// </para>
    /// </summary>
    private const string PinnedScoringConfigVersion = "radar-scoring-fp-a2a3f5490d95";
