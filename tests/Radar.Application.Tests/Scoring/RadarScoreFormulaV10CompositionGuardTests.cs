...
public sealed class RadarScoreFormulaV10CompositionGuardTests
{
    ...
    /// once — radar-scoring-fp-d89b8bc81815 → the value below. ⚠ Spec 194 §2 will move it again when the
    ...
    /// </para>
    /// </summary>
    private const string PinnedScoringConfigVersion = "radar-scoring-fp-412ba7a0b6f5";
