...
public sealed class SignalSourceDescriptorTests
{
    ...
    {
        Assert.Equal(
            "rules=radar-keyword-rules-v6;collectors=newssearch,rss,sec,sec-form4,usaspending;",
    ...
    {
        Assert.Equal(
            "rules=radar-keyword-rules-v6;collectors=;",
    ...
    public void NullAiSource_YieldsCollectorsOnlyDescriptor_NoAiSegment()
    {
        ...
        Assert.Equal(
            "rules=radar-keyword-rules-v6;collectors=rss,sec,usaspending;",
            descriptor);
    ...
    public void AiSource_EscapesReservedDelimiters_KeepsSerializationInjective()
    {
        ...
        Assert.Equal(
            "rules=radar-keyword-rules-v6;collectors=rss;ai=a%3Db%3Bc%2Cd%25e;",
            descriptor);
    }
